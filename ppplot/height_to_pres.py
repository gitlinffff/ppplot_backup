...
inputfile = 'last5_lava-uniform-a4_polar.nc' 
# New output NetCDF file
outputfile = inputfile.replace('_polar.nc','_pres.nc')

# 'new_press_levels' is provided as a 1D numpy array
new_log_press = np.linspace(5., 4.77, 149)  # 149 pressure levels from 1e5 Pa to 1e4.77 Pa
